  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="mb-20 text-center text-3xl font-bold tracking-tighter text-white"
      >
        {title || (
          <span>
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        {src ? (
          ...
          <div className="absolute inset-0 h-full w-full rounded-lg bg-gradient-to-br from-slate-900 to-black" />
        )}
