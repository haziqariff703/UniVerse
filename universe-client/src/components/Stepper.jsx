          ...
          <div className={`px-8 pb-8 ${footerClassName}`}>
            ...
            >
              ...
              <button
                ...
                className="duration-350 flex items-center justify-center rounded-full bg-violet-600 py-1.5 px-3.5 font-medium tracking-tight text-white transition hover:bg-violet-700 active:bg-violet-800"
                {...nextButtonProps}
              >
    ...
    >
      <motion.div
        variants={{
          ...
          complete: { scale: 1, backgroundColor: "#7c3aed", color: "#7c3aed" },
        }}
