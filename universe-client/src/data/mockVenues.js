import surauImage from "../assets/surau_ar_razzaq.png";
...
export const MOCK_VENUES = [
  {
    ...
    max_capacity: 438,
    description:
      "An indoor multi-purpose space situated on the third level of the academic block. Perfect for student club carnivals, exhibitions, and interactive sessions.",
    facilities: [
      "Open Space",
      "Wifi",
      "Power Outlets",
  ...
  },
  {
    ...
    max_capacity: 300,
    description:
      "A serene campus prayer hall that doubles as a multipurpose congregation space for religious programs and community gatherings.",
    facilities: [
      "PA System",
      "AC",
      "Prayer Mats",
  ...
  },
  {
    ...
    max_capacity: 500,
    description:
      "The primary multipurpose hall for large-scale student events, launches, and formal ceremonies. Equipped with professional sound systems.",
    facilities: [
      "Stage",
      "PA System",
      "Sound System",
  ...
  },
  {
    ...
    max_capacity: 500,
    description:
      "Versatile common halls and outdoor lawns within the Jasmine residential college, ideal for student society promotions and club fairs.",
    facilities: [
      "Open Area",
      "Wifi",
      "Benches",
  ...
  },
  {
    ...
    max_capacity: 80,
    description:
      "Academic-focused spaces including seminar rooms and discussion areas. Best for quiet academic competitions and scholarly talks.",
    facilities: [
      "AC",
      "Wifi",
      "Whiteboard",
  ...
  },
  {
    ...
    max_capacity: 1000,
    description:
      "Expansive open spaces for massive outdoor festivals, cultural screenings, and large-scale informal student gatherings.",
    facilities: [
      "Wide Open Space",
      "Natural Ventilation",
      "Stage Setup Ready",
  ...
  },
  {
    ...
    max_capacity: 120,
    description:
      "Professional lecture theaters located within academic blocks, featuring classroom-style setups for educational sessions.",
    facilities: [
      "AC",
      "Projector",
      "Microphone",
