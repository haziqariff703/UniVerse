...
UniVerse is a MERN-stack application designed for UiTM Puncak Perdana students to manage and discover campus events.
...
- **Frontend:** React + Vite + SWC + Tailwind CSS
